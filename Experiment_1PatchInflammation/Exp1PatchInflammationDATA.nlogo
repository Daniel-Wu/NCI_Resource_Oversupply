...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean c_rate of [turtles]"

@#$#@#$#@
## WHAT IS IT?

This model demonstrates the relationship between metabolic rate, motility, neoplasticity, and inflammation, in competing cell populations. Inflammation here is solely external, determined only by the ambient resource renewal rate.
