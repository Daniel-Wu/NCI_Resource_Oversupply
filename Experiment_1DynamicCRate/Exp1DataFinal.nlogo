...
to go
  ...
  if (count turtles with [color = blue]) / (count turtles) > 0.9
  [
    file-close-all
    stop
  ]
...
to go-patches
 ...
 ;;; FOR THIS EXPERIMENT ONLY - ADD INFLAMMAGEN TO WORLD
 set inflammagen (inflammagen + patch_inflammation)
...
to file-init
 ...
 file-print (word "patch_inflammation:" patch_inflammation)
...
"Neoplastic" 1.0 0 -13345367 true "" "ifelse count turtles with [color = blue] > 0\n[\nplot mean [m_rate] of turtles with [color = blue]\n]\n[\nplot 0\n]"
...
"Neoplastic" 1.0 0 -13345367 true "" "plot count turtles with [color = blue]"
...
758
757
Consumption Rate Over Time (Whole Population)
Time
Consumption Rate
0.0
10.0
...
"" ""
PENS
"Mean" 1.0 0 -16777216 true "" "plot mean [c_rate] of turtles"
"Maximum" 1.0 0 -13345367 true "" "plot max [c_rate] of turtles"
"Minimum" 1.0 0 -2674135 true "" "plot min [c_rate] of turtles"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy (mean [c_rate] of turtles) (mean [m_rate] of turtles)"
...
"Neoplastic" 1.0 0 -13345367 true "" "ifelse count turtles with [color = blue] > 0\n[\nplot mean [c_rate] of turtles with [color = blue]\n]\n[\nplot 0\n]"

@#$#@#$#@
## WHAT IS IT?

This model demonstrates the relationship between metabolic rate, motility, neoplasticity, and inflammation, in a dynamically evolving cell population. Inflammation here is solely external, determined only by the ambient resource renewal rate.

## HOW IT WORKS

We assume a single population of cells, which are homogenous in their initial movement and consumption rates. We begin from a uniform distribution of cells, and a random distribution of resources among microenvironments. Furthermore, each cell is initialized with a random amount of resources.
...
> patch_inflammation - the amount of inflammagen added per time step to all patches.
...
> file_name - The name of the file you want data to be exported to.

## EXPERIMENTATION

The effect of ambient inflammation, equivalent to resource disparity, on neoplastic dominance and motility, is the key question. We are interested in the coevolution, and speed of coevolution, between motility and consumption rates, and thus, the effect of chronic inflammation on carcinogenesis.
...
Data is exported to a text file, and is analysed for the effect of inflammation rates on fixation speeds.
...
@#$#@#$#@
<experiments>
  <experiment name="Inflammation Test" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="patch_inflammation" first="0" step="0.1" last="0.5"/>
    ...
    <enumeratedValueSet variable="inflammagen_decay">
      <value value="0.1"/>
    </enumeratedValueSet>
